...
class ReportsTest < ApplicationSystemTestCase
  ...
  test 'creating a Report' do
    ...
    assert_text '日報の詳細'
    assert_text '「フィヨルドブートキャンプへようこそ！」'
    assert_text '「フィヨルドブートキャンプへようこそ！」の課題に取り組んだ。'
    click_on '戻る'
  end
  ...
  test 'updating a Report' do
    ...
    assert_text '日報の詳細'
    assert_text '「JavaScript入門」'
    assert_text '「JavaScript入門」の課題に取り組んだ。'
    click_on '戻る'
  end
  ...
  test 'destroying a Report' do
    ...
    assert_equal reports_url, current_url
